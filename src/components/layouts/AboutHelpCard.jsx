        ...
        <Flex className={"gap-x-[100px] justify-center"}>
          <div className="relative p-12 rounded-[48px] cursor-pointer group">
            ...
            <div className="relative z-60">
              ...
              <Link to={"/"}>
                <button className="cursor-pointer flex items-center py-4 px-5 gap-x-2 outline-2 outline-[#02033B] rounded-[42px] font-inter font-extrabold text-[15px] text-[#02033B] group-hover:outline-[#4335DE] group-hover:bg-[#4335DE] bg-transparent group-hover:text-white transition-colors duration-300">
